...
import { LayoutDashboard, Settings, MessageSquare, Palette, Heart, BarChart3, FileText, Users, Star, List, LogOut, Menu, X, ChevronDown, TrendingUp, Wand2, Sliders, Archive } from 'lucide-react';
...
export default function Layout() {
  ...
  const navItems: NavItem[] = [
    ...
    { path: '/scoring', label: 'Scoring Config', icon: Sliders },
                      ...
                      {item.children!.map((child) => {
                        ...
                        return (
                          <Link
                            key={child.path}
                            to={child.path}
                            className={`flex items-center space-x-3 px-4 py-2 rounded-lg transition-colors ${childActive
                                ? 'bg-blue-50 text-blue-600'
