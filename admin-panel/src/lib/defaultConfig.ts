// Default configuration - embedded in frontend for immediate use
// This mirrors functions/src/modules/cas-core/defaults/default-config.ts

import type { CASConfiguration } from './types';
